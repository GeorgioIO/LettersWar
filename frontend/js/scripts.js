...
async function showForm(type, source = "bar", id = 0) {
  if (type === "delete") {
    ...
    const operationTitle = document.querySelector(
      ".operation-panel .operation-title",
    );
    ...
    const operationScreenText = document.querySelector(
      ".operation-panel .operation-screen .operation-title",
    );
...
function setResetButton() {
  ...
  operationResetButton.addEventListener("click", () => {
    ...
    document.querySelector(".operation-screen .operation-title").innerHTML =
      "Logs : ";
    document.querySelector(".operation-screen .operation-title").style.color =
      "black";
  });
}
